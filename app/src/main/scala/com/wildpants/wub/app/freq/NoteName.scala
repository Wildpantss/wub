...
/** An enum as ''ADT'' for possible names of notes. (currently 12-tone equal temperament only)
  *
  * @note
  *   this enumeration has implemented [[Read]] type-class, so it can be read from [[String]].
  * @author
  *   wildpants
  */
